...
<div id="btnBox"><input type="button" value="เพิ่มรายการ"  onclick="document.location='user.php?act=form'" class="btn_add"/></div>
<table class="tblist">
<tr>
  <th>ลำดับ</th>
  <th>รหัส</th> 
...
<tr style="cursor:pointer;">
  ...
  <td onclick="window.location='user.php?act=form&id=<?=$row['ID'];?>';" ><?=$row['Name'];?></td>
  ...
  <td onclick="window.location='user.php?act=form&id=<?=$row['ID'];?>';" ><?=$row['DateRegister'];?></td>
  <td>
